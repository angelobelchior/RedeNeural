...
var datasetDeTreino = new Dataset(dadosDeTreino, dadosDeSaidasEsperadas, classes);
nn.Treinar(datasetDeTreino, 1000, 0.1);

var datasetDeTeste = new Dataset(testData, dadosDeSaidasEsperadasDeTestes, classes);
